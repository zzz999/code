...
public abstract class PoiExcelHelper {
	...
	/** 获取sheet列表，子类必须实现 */
	public abstract ArrayList<String> getSheetList(InputStream filePath);
	
	/** 读取Excel文件数据 */
	public ArrayList<ArrayList<String>> readExcel(InputStream filePath, int sheetIndex) {
		return readExcel(filePath, sheetIndex, "1-", "1-");
	}
	
	/** 读取Excel文件数据 */
	public ArrayList<ArrayList<String>> readExcel(InputStream filePath, int sheetIndex, String rows) {
		return readExcel(filePath, sheetIndex, rows, "1-");
	}
	
	/** 读取Excel文件数据 */
	public ArrayList<ArrayList<String>> readExcel(InputStream filePath, int sheetIndex, String[] columns) {
		return readExcel(filePath, sheetIndex, "1-", columns);
	}
	
	/** 读取Excel文件数据，子类必须实现 */
	public abstract ArrayList<ArrayList<String>> readExcel(InputStream filePath, int sheetIndex, String rows, String columns);
	...
	/** 读取Excel文件数据，子类必须实现 */
	public abstract ArrayList<ArrayList<String>> readExcel(InputStream filePath, int sheetIndex, String rows, int[] cols);
